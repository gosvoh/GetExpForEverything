...
public class Configuration implements ConfigData {
    ...
    public int          blocks_need_to_destroy    = 100;
    @Comment("How many items you have to craft to get experience")
    public int          items_to_craft            = 100;
    ...
    public int          multiplier_for_level_step = 2;
    @Comment("How many levels needs to reach after multiply base exp")
    public int          level_step                = 5;
    @Comment("Blacklisted blocks, that won't give you experience")
    public List<String> black_list_blocks         = new ArrayList<>();
    @Comment("Blacklisted items, that won't give you experience")
    public List<String> black_list_items          = new ArrayList<>();
    @Comment("Blacklisted block tags, that won't give you experience")
    public List<String> black_list_block_tags     = new ArrayList<>();
    @Comment("Blacklisted item tags, that won't give you experience")
    public List<String> black_list_item_tags      = new ArrayList<>();
    @Comment("This trigger converts your block blacklists to whitelists if true")
    public boolean      is_block_whitelist_mode   = false;
    @Comment("This trigger converts your item blacklists to whitelists if true")
    public boolean      is_item_whitelist_mode    = false;
