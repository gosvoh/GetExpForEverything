...
public final class ConfigHelper {
    public static void bakeClient(final ModConfig config) {
        ...
        GetExpForEverythingConfig.blackListBlockTagsPlace = config.getConfigData().get(prefix + "black_list_block_tags_place");
        ...
        GetExpForEverythingConfig.isPlacingWhitelistMode = config.getConfigData().get(prefix + "is_placing_whitelist_mode");
